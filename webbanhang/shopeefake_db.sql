...
DROP DATABASE IF EXISTS `shopeefake`;
...
INSERT INTO `categories` (`id`, `name`, `icon`) VALUES
	(1, 'Thá»i Trang & Phá»¥ Kiá»‡n', NULL),
	(2, 'Thiáº¿t Bá»‹ Äiá»‡n Tá»­', NULL),
	(3, 'NhÃ  Cá»­a & Äá»i Sá»‘ng', NULL),
	(4, 'Thá»i Trang', 'checkroom'),
	(6, 'LÃ m Äáº¹p', 'face'),
	(7, 'NhÃ  Cá»­a', 'home'),
	(8, 'Thá»ƒ Thao', 'fitness_center'),
	(9, 'Sá»©c Khá»e', 'medical_services'),
	(11, 'Äá»“ ChÆ¡i', 'toys');
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `role`, `is_active`, `avatar`, `phone`, `address`, `remember_token`, `email_verified_at`, `created_at`, `updated_at`) VALUES
	(1, 'TÃ­ Vua', 'admin@shopeefake.com', '$2y$12$/S3I/h/6XNFxmt80LfKC8OuxJXU1vQzwodG8tKSOkNjOBT0DRwLIu', 'admin', 1, 'public/uploads/avatars/avatar_1_1780304978.jpg', '0912345678', 'HÃ  Ná»™i, Viá»‡t Nam', NULL, '2026-06-10 11:10:41', '2026-06-01 15:48:33', '2026-06-10 11:10:41'),
	(2, 'LÃ£o GÃ  KhÃ´', 'user@shopeefake.com', '$2y$12$zDB10aMZB8s77HQl1HpurusRhrdCf9Nz3d0NnQkXDNw7rgRdjC3g2', 'user', 1, NULL, '0987654321', 'TP. Há»“ ChÃ­ Minh, Viá»‡t Nam', NULL, '2026-06-10 11:11:39', '2026-06-01 15:48:33', '2026-06-10 11:11:39'),
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `city` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'TP. Há»“ ChÃ­ Minh',
...
INSERT INTO `products` (`id`, `category_id`, `name`, `price`, `old_price`, `discount_percent`, `stock`, `sold_count`, `city`, `description`, `thumb_url`, `is_flash_sale`, `created_at`) VALUES
	(1, 1, 'Ão thun Cotton Organic thoÃ¡ng khÃ­ 2024', 199000, 299000, 34, 450, 12400, 'TP. Há»“ ChÃ­ Minh', 'Ão thun cotton organic, tháº¥m hÃºt tá»‘t, form basic.', 'uploads/aothun1.jpg', 1, '2026-06-01 15:48:33'),
	(2, 1, 'Quáº§n Jeans Slimfit co giÃ£n 4 chiá»u', 350000, 450000, 22, 318, 3400, 'HÃ  Ná»™i', 'Jeans denim co giÃ£n, dÃ¡ng slimfit.', 'uploads/quanjeans.jpg', 0, '2026-06-01 15:48:33'),
	(3, 1, 'KÃ­nh mÃ¡t UV400 phong cÃ¡ch unisex', 299000, 399000, 25, 209, 672, 'TP. Há»“ ChÃ­ Minh', 'KÃ­nh mÃ¡t chá»‘ng tia UV, nháº¹ vÃ  bá»n.', 'uploads/kinhmatuv400.jpg', 1, '2026-06-01 15:48:33'),
	(4, 2, 'Edifier X5 Pro', 1850000, 2500000, 26, 160, 2300, 'ÄÃ  Náºµng', 'Tai nghe chá»‘ng á»“n chá»§ Ä‘á»™ng, pin lÃ¢u.', 'uploads/edifierx5pro.jpg', 1, '2026-06-01 15:48:33'),
	(5, 4, 'ChÄƒn ga gá»‘i cotton má»m má»‹n', 650000, 790000, 18, 119, 980, 'ÄÃ  Náºµng', 'Bá»™ chÄƒn ga gá»‘i cotton, thoÃ¡ng mÃ¡t.', 'uploads/changagoicotton.jpg', 0, '2026-06-01 15:48:33'),
	(10, 11, 'Äá»“ chÆ¡i tráº» em', 320000, 400000, 20, 10, 0, 'TP. Há»“ ChÃ­ Minh', 'Äá»“ chÆ¡i giÃ¡o dá»¥c giá»›i tÃ­nh cho con nÃ­t', 'uploads/1781057980_bc62446c370338974b87f571eb11fd12.jpg', 0, '2026-06-10 09:19:40');
...
INSERT INTO `orders` (`id`, `user_id`, `order_code`, `customer_name`, `customer_phone`, `customer_address`, `payment_method`, `shipping_fee`, `voucher_amount`, `coins_used`, `total_amount`, `status`, `created_at`, `updated_at`) VALUES
	(1, 2, 'ORD1717257110', 'LÃ£o GÃ  KhÃ´', '0987654321', '123 ÄÆ°á»ng ABC, Quáº­n 1, TP. Há»“ ChÃ­ Minh', 'COD', 30000, 0, 0, 229000, 'pending', '2026-06-01 16:15:00', '2026-06-01 16:15:00'),
	(2, 2, 'ORD1717259999', 'LÃ£o GÃ  KhÃ´', '0987654321', '123 ÄÆ°á»ng ABC, Quáº­n 1, TP. Há»“ ChÃ­ Minh', 'Online', 30000, 50000, 0, 330000, 'completed', '2026-06-02 10:00:00', '2026-06-02 14:30:00'),
	(3, 1, 'SF1780900459220', 'Nguyá»…n VÄƒn A', '090 123 4567', '123 ÄÆ°á»ng LÃª Lá»£i, Quáº­n 1, TP. Há»“ ChÃ­ Minh', 'shopeepay', 32000, 50000, 0, 281000, 'pending', '2026-06-08 13:34:19', '2026-06-08 13:34:19'),
	(4, NULL, 'SF1780903888468', 'cc nÃ¨', '090 123 4567', '123 ÄÆ°á»ng LÃª Lá»£i, Quáº­n 1, TP. Há»“ ChÃ­ Minh', 'cod', 32000, 50000, 0, 632000, 'pending', '2026-06-08 14:31:28', '2026-06-08 14:31:28');
...
INSERT INTO `order_items` (`id`, `order_id`, `product_id`, `product_name`, `price`, `qty`) VALUES
	(1, 1, 1, 'Ão thun Cotton Organic thoÃ¡ng khÃ­ 2024', 199000, 1),
	(2, 2, 2, 'Quáº§n Jeans Slimfit co giÃ£n 4 chiá»u', 350000, 1),
	(3, 3, 3, 'KÃ­nh mÃ¡t UV400 phong cÃ¡ch unisex', 299000, 1),
	(4, 4, 5, 'ChÄƒn ga gá»‘i cotton má»m má»‹n', 650000, 1);
