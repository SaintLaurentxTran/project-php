...
class ProductController
{
    ...
    public function index()
    {
        ...
        include VIEWS_PATH . DIRECTORY_SEPARATOR . 'product' . DIRECTORY_SEPARATOR . 'list.php';
    }
    ...
    public function show($id)
    {
        ...
        if ($product) {
            include VIEWS_PATH . DIRECTORY_SEPARATOR . 'product' . DIRECTORY_SEPARATOR . 'show.php';
        } else {
    ...
    public function add()
    {
        ...
        include VIEWS_PATH . DIRECTORY_SEPARATOR . 'product' . DIRECTORY_SEPARATOR . 'add.php';
    }
    ...
    public function edit($id)
    {
        ...
        $categories = (new CategoryModel($this->db))->getCategories();
        if ($product) {
            include VIEWS_PATH . DIRECTORY_SEPARATOR . 'product' . DIRECTORY_SEPARATOR . 'edit.php';
        } else {
            echo "Không thấy sản phẩm.";
        }
    }
